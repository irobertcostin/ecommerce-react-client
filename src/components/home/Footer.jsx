export default function Footer() {
    ...
    return (
        <>
            ...
            <footer className="bg-indigo-950 text-center  bottom-0 w-full text-white flex flex-col justify-center items-center">
                <div className="container px-6 pt-6">
                    ...
                    <div className="mb-2 w-full ">
                        <p>
                            Elevate your style with our curated collection of designer clothing. Discover exquisite craftsmanship, timeless elegance, and fashion-forward pieces that make a statement. Shop now and set your own trends
                        </p>
                    </div>
